#
#  Be sure to run `pod spec lint WHCNetWorking.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "王红超"
  # s.authors            = { "王红超" => "798907348@qq.com" }
  # s.social_media_url   = "http://twitter.com/王红超"
  ...
  s.source_files  = "WHCNetWorking/WHCNetWorking.h"

  # s.source_files  = "WHCNetWorking/*", "Classes/**/*.{h,m}"
